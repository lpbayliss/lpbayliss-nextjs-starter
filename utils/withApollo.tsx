...
const REALTIME_GRAPHQL_ENDPOINT = process.env.REALTIME_GRAPHQL_ENDPOINT || 'ws://localhost:4000/graphql';

type WithApolloPageContext = NextPageContext & { apolloClient: ApolloClient<NormalizedCacheObject> };
